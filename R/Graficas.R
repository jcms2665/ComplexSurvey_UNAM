...
#2. Gráficas
    ...
    #2.1. Con 1 Variable Discreta
        ...
        #2.1.2. Definir el tipo de gráfica y definir las características
                g1+geom_bar(fill="deepskyblue2",weights=SD$FAC)
    ...
    #2.2. Con 2 Variable Discretas
        ...
        #2.2.1. Opción 1
                ...
                g2+geom_bar(fill="yellowgreen",weights=SD$FAC)+
                  facet_wrap(~ SEX)+
                  ggtitle("Posición en la Ocupación")+
                  xlab("Rango de horas")+
                  ylab("Número de personas")
        ...
        #2.2.1. Opción 2
                ...
                g3+geom_bar(weights=SD$FAC,position = "dodge")+
                  ggtitle("Posición en la Ocupación")+
                  xlab("Rango de horas")+
                  ylab("Número de personas")
    ...
    #2.3. Con 1 Variable Contínua
          ...
          g4+geom_area(stat = "bin",binwidth = 5,weights=SD$FAC)
